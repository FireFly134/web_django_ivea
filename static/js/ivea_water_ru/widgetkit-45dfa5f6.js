...
$widgetkit
  .load("/media/widgetkit/widgets/lightbox/js/lightbox.js")
  .done(function () {
    jQuery(function ($) {
      setTimeout(function () {
...
if (!window["mejs"]) {
  $widgetkit
    .load(
      "/media/widgetkit/widgets/mediaplayer/mediaelement/mediaelement-and-player.js"
    )
    .done(function () {
      jQuery(function ($) {
        mejs.MediaElementDefaults.pluginPath =
          "/media/widgetkit/widgets/mediaplayer/mediaelement/";
          ...
          if (!ele.parent().hasClass("mejs-mediaelement")) {
            ...
            $.onMediaQuery("(max-width: 767px)", {
              valid: function () {
                ele
                  .data("mediaelement")
                  .setPlayerSize("100%", ele.is("video") ? "100%" : h);
              },
              invalid: function () {
...
(function ($) {
  $widgetkit.lazyloaders["slideshow"] = function (element, options) {
    ...
    element.css({ width: o_width == "auto" ? element.width() : o_width });
    var width = ul.width(),
      height = o_height;
    if (height == "auto") {
    ...
    $widgetkit
      .load(WIDGETKIT_URL + "/widgets/slideshow/js/slideshow.js")
      .done(function () {
        element.find("img[data-src]").each(function () {
          var img = $(this),
            src = img.data("src");
  ...
  $widgetkit.lazyloaders["showcase"] = function (element, options) {
    ...
    $widgetkit.lazyloaders["slideset"](
      slideset,
      $.extend({}, options, {
        width: "auto",
        height: "auto",
    ...
    $.when(
      $widgetkit.load(WIDGETKIT_URL + "/widgets/slideset/js/slideset.js"),
      $widgetkit.load(WIDGETKIT_URL + "/widgets/slideshow/js/slideshow.js")
    ).done(function () {
...
$widgetkit
  .load("/media/widgetkit/widgets/spotlight/js/spotlight.js")
  .done(function () {
    jQuery(function ($) {
