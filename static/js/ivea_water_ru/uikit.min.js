...
(function (t) {
  if (
    ...
    throw Error("UIkit requires jQuery");
    ...
    : ((n.version = "2.5.0"),
      (n.fn = function (t, i) {
        ...
        return n[a]
          ? this.each(function () {
              var t = e(this),
                s = t.data(a);
              s || t.data(a, (s = new n[a](this, r ? void 0 : i))),
            ...
            try {
              for (c = document.styleSheets, o = 0, r = c.length; r > o; o++) {
                for (
                  ...
                  n.cssRules[e].type === CSSRule.STYLE_RULE &&
                    t.test(n.cssRules[e].selectorText) &&
                    i.unshift(e);
      ...
      (n.Utils.isInView = function (t, i) {
        ...
        var o = s.scrollLeft(),
          ...
          u = r.top;
        return (
          (i = e.extend({ topoffset: 0, leftoffset: 0 }, i)),
          u + n.height() >= a &&
          u - i.topoffset <= a + s.height() &&
          l + n.width() >= o &&
          l - i.leftoffset <= o + s.width()
            ? !0
            : !1
        );
      }),
      ...
      (n.Utils.template = function (t, e) {
        for (
          ...
          if (((i = a[r]), i.match(/\{\{\s*(.+?)\s*\}\}/)))
            switch (
              ((r += 1),
              (i = a[r]),
              (n = i[0]),
              (o = i.substring(i.match(/^(\^|\#|\!|\~|\:)/) ? 1 : 0)),
              n)
            ) {
              case "~":
                l.push(
        ...
        s = [
          ...
          "try {",
          "with($data){",
          u ? '__ret = ["Not all blocks are closed correctly."]' : l.join(""),
          "};",
      ...
      (e.UIkit = n),
      (e.fn.uk = n.fn),
      (e.UIkit.langdirection = "rtl" == o.attr("dir") ? "right" : "left"),
      e(function () {
        if ((e(i).trigger("uk-domready"), n.support.mutationobserver)) {
          var t = new n.support.mutationobserver(
          ...
          t.observe(document.body, { childList: !0, subtree: !0 }),
            n.support.touch &&
              n.Utils.removeCssRules(/\.uk-(?!navbar).*:hover/);
        }
      }),
  ...
  (function (t, e) {
    ...
    t.extend(o.prototype, {
        ...
        if (o !== !1)
          return (
            this.columns.each(function () {
              ...
              n.is(":visible") &&
                (i
                  ? n.addClass(e.options.cls)
                  : n.offset().top != o &&
                    (n.addClass(e.options.cls), (i = !0)));
            }),
            this
          );
      },
      ...
      (o.defaults = { cls: "uk-margin-small-top" }),
      (e.stackMargin = o),
      t(document).on("uk-domready", function () {
        t("[data-uk-margin]").each(function () {
          var i,
            n = t(this);
          n.data("stackMargin") ||
            (i = new o(n, e.Utils.options(n.attr("data-uk-margin"))));
        });
      });
  })(jQuery, jQuery.UIkit),
  (function (t) {
    ...
    t(function () {
      var f,
        ...
        v = 0;
      "MSGesture" in window &&
        ((c = new MSGesture()), (c.target = document.body)),
        t(document)
          .bind("MSGestureEnd", function (t) {
            var e =
              t.originalEvent.velocityX > 1
                ? "Right"
                : -1 > t.originalEvent.velocityX
                ? "Left"
                : t.originalEvent.velocityY > 1
                ? "Down"
                : -1 > t.originalEvent.velocityY
                ? "Up"
                : null;
            e && (h.el.trigger("swipe"), h.el.trigger("swipe" + e));
          })
          .on("touchstart MSPointerDown", function (e) {
            ("MSPointerDown" != e.type || s(e.originalEvent)) &&
              ((m = "MSPointerDown" == e.type ? e : e.originalEvent.touches[0]),
              (f = Date.now()),
              (p = f - (h.last || f)),
              (h.el = t(
              ...
              c &&
                ...
                c.addPointer(e.originalEvent.pointerId));
          })
          .on("touchmove MSPointerMove", function (t) {
            ("MSPointerMove" != t.type || s(t.originalEvent)) &&
              ((m = "MSPointerMove" == t.type ? t : t.originalEvent.touches[0]),
              n(),
              (h.x2 = m.pageX),
              (h.y2 = m.pageY),
          ...
          .on("touchend MSPointerUp", function (i) {
            ("MSPointerUp" != i.type || s(i.originalEvent)) &&
              (n(),
  ...
  (function (t, e) {
    ...
    var i = function (e, n) {
      ...
      (this.options = t.extend({}, i.defaults, n)),
        (this.element = t(e)),
        this.element.data("alert") ||
          (this.element.on("click", this.options.trigger, function (t) {
    ...
    t.extend(i.prototype, {
      ...
      (i.defaults = { fade: !0, duration: 200, trigger: ".uk-alert-close" }),
      (e.alert = i),
      t(document).on("click.alert.uikit", "[data-uk-alert]", function (n) {
        var o = t(this);
        if (!o.data("alert")) {
          var s = new i(o, e.Utils.options(o.data("uk-alert")));
          t(n.target).is(o.data("alert").options.trigger) &&
  ...
  (function (t, e) {
    ...
    var i = function (e, n) {
      ...
      s.data("buttonRadio") ||
        ((this.options = t.extend({}, i.defaults, n)),
        (this.element = s.on("click", this.options.target, function (e) {
          e.preventDefault(),
            s.find(o.options.target).not(this).removeClass("uk-active").blur(),
    ...
    var n = function (e, i) {
      var o = t(e);
      o.data("buttonCheckbox") ||
        ((this.options = t.extend({}, n.defaults, i)),
        (this.element = o.on("click", this.options.target, function (e) {
          e.preventDefault(),
            o.trigger("change", [t(this).toggleClass("uk-active").blur()]);
        })),
    ...
    var o = function (e, i) {
      ...
      s.data("button") ||
        ...
        (this.element = s.on("click", function (t) {
          t.preventDefault(),
            n.toggle(),
            s.trigger("change", [s.blur().hasClass("uk-active")]);
        })),
    ...
    t.extend(o.prototype, {
      ...
      t(document).on(
        ...
        function (i) {
          ...
          if (!o.data("buttonCheckbox")) {
            var s = new n(
              o,
              e.Utils.options(o.attr("data-uk-button-checkbox"))
            );
      ...
      t(document).on("click.button.uikit", "[data-uk-button]", function () {
        var e = t(this);
        e.data("button") ||
          (new o(e, e.attr("data-uk-button")), e.trigger("click"));
      });
  })(jQuery, jQuery.UIkit),
  (function (t, e) {
    "use strict";
    var i = !1,
      n = function (o, s) {
        ...
        r.data("dropdown") ||
          ...
          "click" == this.options.mode || e.support.touch
            ? this.element.on("click", function (e) {
                var n = t(e.target);
                n.parents(".uk-dropdown").length ||
                  ((n.is("a[href='#']") || n.parent().is("a[href='#']")) &&
                    e.preventDefault(),
                  n.blur()),
                  a.element.hasClass("uk-open")
                    ? (n.is("a") ||
                        !a.element.find(".uk-dropdown").find(e.target)
                          .length) &&
                      (a.element.removeClass("uk-open"), (i = !1))
                    : a.show();
              })
            : this.element
                ...
                .on("mouseleave", function () {
                  a.remainIdle = setTimeout(function () {
                    a.element.removeClass("uk-open"),
                      (a.remainIdle = !1),
                      i && i[0] == a.element[0] && (i = !1);
    ...
    t.extend(n.prototype, {
      remainIdle: !1,
      show: function () {
        i && i[0] != this.element[0] && i.removeClass("uk-open"),
      ...
      registerOuterClick: function () {
        var e = this;
        t(document).off("click.outer.dropdown"),
          setTimeout(function () {
            t(document).on("click.outer.dropdown", function (n) {
              !i ||
                i[0] != e.element[0] ||
                (!t(n.target).is("a") &&
                  e.element.find(".uk-dropdown").find(n.target).length) ||
                (i.removeClass("uk-open"),
                t(document).off("click.outer.dropdown"));
            });
          }, 10);
      },
      checkDimensions: function () {
        if (this.dropdown.length) {
          var e = this.dropdown
              .css("margin-" + t.UIkit.langdirection, "")
              .css("min-width", ""),
            i = e.show().offset(),
            n = e.outerWidth(),
          ...
          if (
            (this.centered &&
              (e.css(
                "margin-" + t.UIkit.langdirection,
                -1 * (parseFloat(n) / 2 - e.parent().width() / 2)
              ),
              (i = e.offset()),
              (n + i.left > o || 0 > i.left) &&
                (e.css("margin-" + t.UIkit.langdirection, ""),
                (i = e.offset()))),
          ...
          n + (i.left - s) > o &&
            (e.addClass("uk-dropdown-flip"), (i = e.offset())),
            0 > i.left && e.addClass("uk-dropdown-stack"),
            e.css("display", "");
        }
      },
    }),
    ...
    t(document).on(o + ".dropdown.uikit", "[data-uk-dropdown]", function (i) {
      ...
      if (!s.data("dropdown")) {
        ...
        ("click" == o || ("mouseenter" == o && "hover" == a.options.mode)) &&
          a.show(),
          a.element.find(".uk-dropdown").length && i.preventDefault();
      }
    });
  })(jQuery, jQuery.UIkit),
  (function (t, e) {
      ...
      o = function (s, a) {
        ...
        l.data("gridMatchHeight") ||
          ...
          this.columns.length &&
            ...
            t(document).on("uk-domready", function () {
              (r.columns = r.element.children()),
                (r.elements = r.options.target
                  ? r.element.find(r.options.target)
                  : r.columns),
                r.match();
            }),
    ...
    t.extend(o.prototype, {
      match: function () {
        ...
        if (e.length) {
          var i =
              Math.ceil(
                (100 * parseFloat(e.css("width"))) /
                  parseFloat(e.parent().css("width"))
              ) >= 100
                ? !0
                : !1,
            n = this;
                ...
                ? (this.element.width(),
                  setTimeout(function () {
                    ...
                    n.elements.each(function () {
                      ...
                      s != e &&
                        i.length &&
                        (n.matchHeights(t(i)), (i = []), (s = o.offset().top)),
                        i.push(o),
                        (e = s);
                    }),
    ...
    (s.defaults = { cls: "uk-grid-margin" }),
      ...
      t(document).on("uk-domready", function () {
        t("[data-uk-grid-match],[data-uk-grid-margin]").each(function () {
          var i,
            n = t(this);
          n.is("[data-uk-grid-match]") &&
            !n.data("gridMatchHeight") &&
            (i = new o(n, e.Utils.options(n.attr("data-uk-grid-match")))),
            n.is("[data-uk-grid-margin]") &&
              !n.data("gridMargin") &&
              (i = new s(n, e.Utils.options(n.attr("data-uk-grid-margin"))));
        });
      });
  })(jQuery, jQuery.UIkit),
  (function (t, e, i) {
      ...
      return i
        ? ("object" == typeof e
            ? ((e = e instanceof jQuery ? e : t(e)),
              e.parent().length &&
                ((i.persist = e),
                i.persist.data("modalPersistParent", e.parent())))
            : (e =
                "string" == typeof e || "number" == typeof e
                  ? t("<div></div>").html(e)
                  : t("<div></div>").html(
                      "$.UIkitt.modal Error: Unsupported data type: " + typeof e
                    )),
          e.appendTo(i.element.find(".uk-modal-dialog")),
          i)
        : void 0;
    }
    var o = !1,
      ...
      a = function (i, n) {
        ...
        (this.element = t(i)),
          ...
          (this.transition = e.support.transition),
          ...
          this.element
            .on("click", ".uk-modal-close", function (t) {
    ...
    t.extend(a.prototype, {
      ...
      resize: function () {
        ...
        if (
          ((this.scrollbarwidth = window.innerWidth - s.width()),
          s.css(t, this.scrollbarwidth),
          this.element.css(t, ""),
          this.dialog.offset().left > this.scrollbarwidth &&
            this.element.css(t, this.scrollbarwidth),
          this.scrollable)
        ) {
          ...
          this.scrollable.css(
            "height",
            this.options.minScrollHeight > a ? "" : a
          );
        }
      },
      _hide: function () {
        this.element.hide().removeClass("uk-open"),
          s
            ...
            .css(
              "padding-" + ("left" == e.langdirection ? "right" : "left"),
              ""
            ),
          o === this && (o = !1),
    ...
    var r = function (e, i) {
      ...
      o.data("modal") ||
        ...
        (this.element = o),
        (this.modal = new a(this.options.target, i)),
    ...
    (r.dialog = function (e, i) {
      ...
      return (
        o.element.on("uk.modal.hide", function () {
          o.persist &&
      ...
      (r.Modal = a),
      (e.modal = r),
      t(document).on("click.modal.uikit", "[data-uk-modal]", function (i) {
        var n = t(this);
  ...
  (function (t, e) {
    ...
    var i,
      ...
      s = {
        show: function (e) {
          if (((e = t(e)), e.length)) {
            var a = t("html"),
              ...
              c =
                -1 == u && n.width() < window.innerWidth
                  ? window.innerWidth - n.width()
                  : 0;
            (i = { x: window.scrollX, y: window.scrollY }),
              ...
              e
                .off(".ukoffcanvas")
                .on(
                  "click.ukoffcanvas swipeRight.ukoffcanvas swipeLeft.ukoffcanvas",
                  function (e) {
                    var i = t(e.target);
                    if (
                      !e.type.match(/swipe/) &&
                      !i.hasClass("uk-offcanvas-close")
                    ) {
        ...
        hide: function (e) {
          ...
          s.length &&
            (t.UIkit.support.transition && !e
              ? (n
                  .one(t.UIkit.support.transition.end, function () {
    ...
    (a.offcanvas = s),
      (e.offcanvas = a),
      o.on("click.offcanvas.uikit", "[data-uk-offcanvas]", function (i) {
        i.preventDefault();
        var n = t(this);
        n.data("offcanvas") ||
          (new a(n, e.Utils.options(n.attr("data-uk-offcanvas"))),
          n.trigger("click"));
      });
  })(jQuery, jQuery.UIkit),
  (function (t, e) {
    ...
    var n = function (e, i) {
      ...
      s.data("nav") ||
        ((this.options = t.extend({}, n.defaults, i)),
        (this.element = s.on("click", this.options.toggle, function (e) {
          e.preventDefault();
          var i = t(this);
    ...
    t.extend(n.prototype, {
      open: function (e, n) {
        ...
        this.options.multiple ||
          ...
          s.toggleClass("uk-open"),
          s.data("list-container") &&
            (n
              ? s
                  .data("list-container")
                  .stop()
                  .height(s.hasClass("uk-open") ? "auto" : 0)
              : s
                  .data("list-container")
                  .stop()
                  .animate({
                    height: s.hasClass("uk-open")
                      ? i(s.data("list-container").find("ul:first"))
                      : 0,
                  }));
      },
    }),
    ...
    t.extend(s.prototype, {
      ...
      show: function () {
        if ((o && clearTimeout(o), this.tip.length)) {
          n.stop().css({ top: -2e3, visibility: "hidden" }).show(),
            n.html('<div class="uk-tooltip-inner">' + this.tip + "</div>");
          var e = this,
            ...
            c = l.split("-");
          ("left" != c[0] && "right" != c[0]) ||
            "right" != t.UIkit.langdirection ||
            (c[0] = "left" == c[0] ? "right" : "left");
          var h = {
            bottom: {
          ...
          t.extend(u, h[c[0]]),
            2 == c.length &&
              (u.left = "left" == c[1] ? i.left : i.left + i.width - s);
          ...
          (u.left -= t("body").position().left),
            (o = setTimeout(function () {
              n.css(u).attr("class", "uk-tooltip uk-tooltip-" + l),
                e.options.animation
                  ? n
                      .css({ opacity: 0, display: "block" })
                      .animate(
                        { opacity: 1 },
                        parseInt(e.options.animation, 10) || 400
                      )
                  : n.show(),
                (o = !1);
      ...
      hide: function () {
        (this.element.is("input") &&
          ...
          this.options.animation
            ? n.fadeOut(parseInt(this.options.animation, 10) || 400)
            : n.hide());
      },
      content: function () {
        return this.tip;
      ...
      checkBoundary: function (t, e, n, o) {
        var s = "";
        return (
          (0 > t || t - i.scrollLeft() + n > window.innerWidth) && (s += "x"),
          (0 > e || e - i.scrollTop() + o > window.innerHeight) && (s += "y"),
          s
        );
      },
    }),
      ...
      t(document).on(
        ...
        function () {
          var i = t(this);
          i.data("tooltip") ||
            (new s(i, e.Utils.options(i.attr("data-uk-tooltip"))),
  ...
  (function (t, e) {
    ...
    var i = function (e, n) {
      ...
      if (!s.data("switcher")) {
        if (
          ((this.options = t.extend({}, i.defaults, n)),
          (this.element = s.on("click", this.options.toggle, function (t) {
          ...
          r.length
            ? this.show(r)
            : ((r = a.eq(this.options.active)),
              this.show(r.length ? r : a.eq(0)));
        }
    ...
    t.extend(i.prototype, {
      ...
      (i.defaults = { connect: !1, toggle: ">*", active: 0 }),
      (e.switcher = i),
      t(document).on("uk-domready", function () {
        t("[data-uk-switcher]").each(function () {
          var n = t(this);
          n.data("switcher") ||
            new i(n, e.Utils.options(n.attr("data-uk-switcher")));
        });
      });
  })(jQuery, jQuery.UIkit),
  (function (t, e) {
    ...
    var i = function (e, n) {
      ...
      if (!s.data("tab")) {
        ...
        var r = t(
            '<li class="uk-tab-responsive uk-active"><a href="javascript:void(0);"></a></li>'
          ),
          l = r.find("a:first"),
          u = t(
          ...
          c = u.find("ul");
        l.html(this.element.find("li.uk-active:first").find("a").text()),
          this.element.hasClass("uk-tab-bottom") &&
            u.addClass("uk-dropdown-up"),
          this.element.hasClass("uk-tab-flip") &&
            u.addClass("uk-dropdown-flip"),
          this.element.find("a").each(function (e) {
            var i = t(this).parent(),
              n = t(
                '<li><a href="javascript:void(0);">' + i.text() + "</a></li>"
              ).on("click", function () {
          ...
          r.append(u).uk("dropdown", { mode: "click" }),
          this.element
            .append(r)
            .data({ dropdown: r.data("dropdown"), mobilecaption: l })
  ...
  (function (t, e) {
    ...
    var i = t(window),
      ...
      o = function () {
        for (var t = 0; n.length > t; t++)
          e.support.requestAnimationFrame.apply(window, [n[t].check]);
      },
      s = function (i, o) {
        var a = t(i);
        if (!a.data("scrollspy")) {
          ...
          var r,
            ...
            h = function () {
              ...
              t &&
                ...
                (r && clearTimeout(r),
                u ||
                  (c.element.addClass(c.options.initcls),
                  (c.offset = c.element.offset()),
                  (u = !0),
                  c.element.trigger("uk-scrollspy-init")),
                (r = setTimeout(function () {
                  t &&
                    c.element
                      .addClass("uk-scrollspy-inview")
                      .addClass(c.options.cls)
                      .width();
                }, c.options.delay)),
                (l = !0),
                c.element.trigger("uk.scrollspy.inview")),
                !t &&
                  l &&
                  c.options.repeat &&
                  (c.element
                    .removeClass("uk-scrollspy-inview")
                    .removeClass(c.options.cls),
                  (l = !1),
                  c.element.trigger("uk.scrollspy.outview"));
            };
          h(),
          ...
          var r,
            ...
            f = function () {
              ...
              for (var t = 0; h.length > t; t++)
                e.Utils.isInView(h.eq(t), d.options) && r.push(h.eq(t));
              if (r.length) {
                var n = i.scrollTop(),
                  o = (function () {
                ...
                d.options.closest
                  ? c
                      .closest(d.options.closest)
                      .removeClass(d.options.cls)
                      .end()
                      .filter("a[href='#" + o.attr("id") + "']")
                      .closest(d.options.closest)
                      .addClass(d.options.cls)
                  : c
                      .removeClass(d.options.cls)
                      .filter("a[href='#" + o.attr("id") + "']")
                      .addClass(d.options.cls);
    ...
    i.on("scroll", u).on("resize orientationchange", e.Utils.debounce(u, 50)),
      t(document).on("uk-domready", function () {
        t("[data-uk-scrollspy]").each(function () {
          var i = t(this);
          i.data("scrollspy") ||
            new s(i, e.Utils.options(i.attr("data-uk-scrollspy")));
        }),
          t("[data-uk-scrollspy-nav]").each(function () {
            var i = t(this);
            i.data("scrollspynav") ||
              new l(i, e.Utils.options(i.attr("data-uk-scrollspy-nav")));
          });
      });
  })(jQuery, jQuery.UIkit),
  (function (t, e) {
    ...
    var i = function (e, n) {
      ...
      s.data("smoothScroll") ||
        ((this.options = t.extend({}, i.defaults, n)),
        (this.element = s.on("click", function () {
    ...
    (i.defaults = { duration: 1e3, transition: "easeOutExpo", offset: 0 }),
      (e.smoothScroll = i),
      t.easing.easeOutExpo ||
        (t.easing.easeOutExpo = function (t, e, i, n, o) {
      ...
      t(document).on(
        ...
        function () {
          var n = t(this);
          n.data("smoothScroll") ||
            (new i(n, e.Utils.options(n.attr("data-uk-smooth-scroll"))),
            n.trigger("click"));
        }
      );
  })(jQuery, jQuery.UIkit),
  (function (t, e, i) {
    ...
    e.extend(n.prototype, {
      ...
      (n.defaults = { target: !1, cls: "uk-hidden" }),
      (i.toggle = n),
      e(document).on("uk-domready", function () {
        e("[data-uk-toggle]").each(function () {
          var t = e(this);
          t.data("toggle") ||
            new n(t, i.Utils.options(t.attr("data-uk-toggle")));
        });
      });
