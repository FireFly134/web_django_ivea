/*
 * Copyright В© 2014 NoNumber All Rights Reserved
    ...
    $.each($("#colorbox"), function (i, el) {
      ...
      if ($title_height > $margin_top) {
        ...
        if (parseInt($el.css("top")) < 23) {
          $content.css(
            "height",
            parseInt($content.css("height")) - $div_height
          );
        } else {
          ...
          $("#cboxWrapper").css(
            "height",
            parseInt($("#cboxWrapper").css("height")) + $div_height
          );
          $("#cboxContent").css(
            "height",
            parseInt($("#cboxContent").css("height")) + $div_height
          );
          $("#cboxMiddleLeft").css(
            "height",
            parseInt($("#cboxMiddleLeft").css("height")) + $div_height
          );
          $("#cboxMiddleRight").css(
            "height",
            parseInt($("#cboxMiddleRight").css("height")) + $div_height
          );
        }
      }
    });
