...
(function (t, e, i) {
  ...
  function p() {
    !y &&
      ...
      (O = K.add(P).add(R).add(F)),
      t(e.body).append(v, y.append(x, M)));
  }
  function m() {
    function i(t) {
      t.which > 1 ||
  ...
  var v,
    ...
    ce = (function () {
      ...
      function i() {
        F.html(_.get("slideshowStop")).unbind(s).one(s, n),
