...
(function (c) {
  ...
  3: function (f, e, h, c) {
    var k = f("4")["array"];
    var l =
      "pop,push,reverse,shift,sort,splice,unshift,concat,join,slice,toString,indexOf,lastIndexOf,forEach,every,some,filter,map,reduce,reduceRight".split(
        ","
      );
    ...
    if (!g.indexOf) {
      g.indexOf = function (o, p) {
        for (
          var m = this.length >>> 0, n = p < 0 ? Math.max(0, m + p) : p || 0;
          n < m;
          n++
        ) {
  ...
  4: function (d, c, e, b) {
    ...
    for (
      var g = "string,number,array,object,date,function,regexp".split(","),
        f = g.length;
      f--;
  ...
  5: function (g, d, h, c) {
    ...
    if (!{ valueOf: 0 }.propertyIsEnumerable("valueOf")) {
      var f =
        "constructor,toString,valueOf,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString".split(
          ","
        );
  ...
  7: function (k, h, ae, d) {
    ...
    var L =
      "border:none;margin:none;padding:none;visibility:hidden;position:absolute;height:0;";
    ...
    var U = function (au, ar) {
      ...
      var at = au.match(C),
        e = au.match(J);
      return aa(
        [Z(e ? e[0] : "", ar), i(at ? at[0] : "", ar), v(aw, ar)].join(" ")
      );
    };
    var u = function (ar, e) {
      if (ar == null || ar === "") {
    ...
    c(A, function (ar) {
      var e = "border" + ar;
      c(
        ["margin" + ar, "padding" + ar, e + "Width", ar.toLowerCase()],
        function (at) {
          y[at] = Z;
        }
      );
    ...
    y.opacity = j;
    var ab =
      (s.style.MsFilter != null && "MsFilter") ||
      (s.style.filter != null && "filter");
    if (ab && s.style.opacity == null) {
      ...
      r.opacity = function (ar) {
        ar =
          (ar = j(ar)) === "1"
            ? ""
            : "alpha(opacity=" + Math.round(ar * 100) + ")";
        var e = w(this)(ab);
    ...
    if (!n && D) {
      (function () {
        ...
        var ax = function (az) {
          var aA = av.apply(null, az.match(au).slice(1)) || [
            [0, 0],
            0,
            0,
            [0, 0],
          ...
          return [
            "translate(" +
              ...
              ")",
            "rotate(" + ag((aA[1] * 180) / Math.PI) + "deg)",
            "skewX(" + ag((aA[2] * 180) / Math.PI) + "deg)",
            "scale(" + N(aA[3], ag) + ")",
          ].join(" ");
        };
        var at = function (az) {
    ...
    var al = E({
      ...
      resetCSS: function (ar) {
        var aw = w(this.node),
          ...
          e = (aw(n + "TimingFunction").replace(/\s+/g, "") || "ease").match(
            /cubic-bezier\([\d-.,]+\)|([a-z-]+)/g
          );
        ap("all", av, au, e);
    ...
    m.implement({
      ...
      compute: function (at) {
        ...
        var ar = M(at).call(e);
        return ar != null
          ? ar.replace(f, function (au, aw, av) {
  ...
  9: function (e, d, g, c) {
    var j = e("4")["string"];
    var k =
      "charAt,charCodeAt,concat,contains,endsWith,indexOf,lastIndexOf,localeCompare,match,replace,search,slice,split,startsWith,substr,substring,toLocaleLowerCase,toLocaleUpperCase,toLowerCase,toString,toUpperCase,trim,valueOf".split(
        ","
      );
  ...
  a: function (g, f, h, e) {
    ...
    var c = function (l) {
      return l === e
        ? "global"
        : l.uniqueNumber || (l.uniqueNumber = "n:" + (k++).toString(36));
    };
    var b = {};
    var i = d({
  ...
  b: function (h, b, r, n) {
    ...
    var f = c({
      ...
      start: function (x, w) {
        ...
        this.templateTo = s[1];
        if (
          this.from.length !== this.to.length ||
  ...
  c: function (b, c, a, d) {
    c.exports = function (h, j, f, i, l) {
      ...
      var k = function (n) {
        var m = 1 - n;
        return (
          3 * (2 * (n - 1) * n + m * m) * h + 3 * (-n * n * n + 2 * m * n) * f
        );
      };
      return function (p) {
        var m = p,
    ...
    b[d] = e
      ? Object.append({}, f, {
          ...
          condition: function (h, g) {
            return (
              (!e.condition || e.condition.call(this, h, g)) &&
              (!f.condition || f.condition.call(this, h, g))
            );
          },
          onAdd: a(f, e, "onAdd"),
...
if (Browser.Features.iOSTouch) {
  (function () {
    ...
    Element.defineCustomEvent(a, { base: "touchend" });
  })();
}
        ...
        google_maps: {
          ...
          url: function (a, b) {
            return (
              ...
              a[4] +
              "&output=" +
              (a[4].indexOf("layer=c") > 0 ? "svembed" : "embed")
            );
          },
        },
      },
...
(function () {
  ...
  this.RokBox.Class = new Class({
    ...
    attach: function () {
      ...
      var m = 0;
      var i = document.retrieve(
          this.options.data + ":open",
          function (o, n) {
        ...
        l = document.retrieve(
          ...
          function (o, n) {
            ...
            if (
              o.target &&
              !o.target.get("data-rokboxclose") &&
              (o.target == this.container || this.container.contains(o.target))
            ) {
              return true;
            }
            if (
              o.target &&
              !o.target.get("data-rokboxclose") &&
              (o.target == this.header ||
                this.header.contains(o.target) ||
                o.target == this.footer ||
                this.footer.contains(o.target))
            ) {
              return true;
            }
            this.close();
        ...
        h = document.retrieve(
          this.options.data + ":toggleFitscreen",
          function (o, n) {
            if (o && o.rightClick) {
              return true;
            }
        ...
        f = document.retrieve(
          ...
          function (p, n) {
            ...
            if (!n && (p.key == "left" || p.key == "right")) {
              n = document.getElement(
                "[data-rokbox" + (p.key == "left" ? "previous" : "next") + "]"
              );
            }
            if (!n && (p.direction == "left" || p.direction == "right")) {
              n = document.getElement(
                "[data-rokbox" +
                  (p.direction == "left" ? "previous" : "next") +
                  "]"
              );
            }
            o = document.getElement(
              "[href=" +
                n.get("data-rokboxnavigation") +
                "][data-rokbox-album=" +
                n.get("data-rokboxnavigation-album") +
                "]"
            );
            if (o) {
              this.load(o);
      ...
      if (Browser.Features.Touch && !Browser.Platform.win) {
        ...
        var k;
        document
          .getElements(".gf-menu li a")
          .addEvent("touchstart", function (n) {
            ...
            if (
              k === this ||
              this.getParent("li").hasClass("grouped") ||
              this.getParent("li").hasClass("modules")
            ) {
              return this.click();
            }
            k = this;
      ...
      $$("[data-rokbox]").addEvent(
        this.isTouch ? "touchstart" : "click",
        function (n) {
          if (n) {
            n.preventDefault();
          }
    ...
    load: function (n) {
      ...
      var i = n.get("href"),
        j = this.media.format(i),
        t = this.media.getType(i),
        g = this.media.getAspect(i),
        l,
        r,
        m = {},
        k,
      ...
      v = n.get("data-rokbox-size")
        ? n.get("data-rokbox-size").split(" ")
        : false;
      m = { href: j, element: n, type: t, aspect: g, size: v };
      switch (t) {
        case "image":
          l = new Image();
          break;
        case "element":
          ...
          break;
        case "audio":
          f = v ? { width: v[0], height: v[1] } : { width: 300, height: 30 };
            ...
            l = new Element("object", {
              ...
              .set(
                ...
                '<param name="filename" value="' +
                  i +
                  '"><param name="ShowControls" value="1"><param name="AutoStart" value="true"><embed type="application/x-mplayer-2" src="' +
                  i +
                  '" width="' +
                  f.width +
                  '" height="' +
                  (f.height + 60) +
                  '" showcontrols="true" autostart="true"></embed>'
              )
              .setStyles({ width: f.width, height: f.height });
            m.html5 = false;
          } else {
          ...
          break;
        case "video":
          f = v ? { width: v[0], height: v[1] } : { width: 600, height: 400 };
          if (i.match(/\.swf$/i) && Browser.firefox) {
            l = new Element("object", {
              ...
              .set(
                ...
                '<param name="movie" value="' +
                  ...
                  i +
                  '" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" width="' +
                  f.width +
                  '" height="' +
                  f.height +
            ...
            if (v) {
              ...
              l.setStyles({ width: "100%", height: "auto" });
            }
            Object.forEach(
              k,
              function (h, w) {
        ...
        case "swf":
          ...
          l.adopt(new Element("param", { name: "move", value: j }));
          Object.forEach(
            k,
            function (h, w) {
      ...
      if (s) {
        if (m.html5 && m.type == "video") {
          l.addEventListener(
            "canplay",
            function () {
              m.videoSize = { width: l.videoWidth, height: l.videoHeight };
        ...
        if (Browser.firefox && !!i.match(/\.mp4$/i)) {
          if (!l.canPlayType("video/mp4")) {
            new Element("source")
              ...
              .inject(l, "top");
            new Element("source")
              .set("src", i.replace(/\.mp4/, ".ogg"))
              .set("type", "video/ogg")
              .inject(l, "top");
            new Element("source")
              .set("src", i.replace(/\.mp4/, ".ogv"))
              .set("type", "video/ogv")
              .inject(l, "top");
            new Element("source")
              .set("src", i.replace(/\.mp4/, ".webm"))
              .set("type", "video/webm")
              .inject(l, "top").onerror = this._setError.pass([l, m], this);
          }
        }
    ...
    fitscreen: function (h) {
      var i =
        this.containerContent.getElement("img") ||
        this.containerContent.getElement("iframe");
      if (!i) {
        return;
      }
      var g = {
    ...
    unfitscreen: function (h) {
      var g = {
          maxWidth: this.container.retrieve(
            this.options.data + ":fitscreen-size"
          ).maxWidth,
          maxHeight: this.container.retrieve(
            this.options.data + ":fitscreen-size"
          ).maxHeight,
          width: this.container.retrieve(this.options.data + ":fitscreen-size")
            .width,
          height: this.container.retrieve(this.options.data + ":fitscreen-size")
            .height,
        },
        f = this.container.retrieve(
          this.options.data + ":fitscreen-size"
        ).viewport;
      if (a || e) {
      ...
      document
        .getElement("[data-rokboxfitscreen]")
        .setStyle("display", "block");
      if (a || e) {
    ...
    setNavigation: function (g) {
      ...
      h.set("data-rokboxnavigation", j.get("href")).set(
        "data-rokboxnavigation-album",
        j.get("data-rokbox-album")
      );
      l.set("data-rokboxnavigation", i.get("href")).set(
        "data-rokboxnavigation-album",
        i.get("data-rokbox-album")
      );
    ...
    setFitting: function () {
      document
        .getElements(
          this.isFitting ? "[data-rokboxunfitscreen]" : "[data-rokboxfitscreen]"
        )
        .setStyle("display", "none");
    },
    ...
    _build: function () {
      ...
      var g = ["outer", "row", "inner", "container"],
        f = ["loader", "content", "controls"],
        h = {
          x: "close",
          p: "previous",
          n: "next",
      ...
      this.wrapper = new Element(
        "div[data-rokboxwrapper]." + this.options.data + "-wrapper"
      ...
      g.forEach(function (k, j) {
        this[k] = new Element(
          "div[data-" +
            ...
            "-" +
            k
        ).inject(this[g[j - 1]] || this.wrapper);
      }, this);
      f.forEach(function (j) {
        this["container" + j.capitalize()] = new Element(
          "div[data-" +
            this.options.data +
            j +
            "]." +
      ...
      ["header", "footer"].forEach(function (k, j) {
        this[k] = new Element(
          "div[data-" +
            ...
            "-" +
            k
        ).inject(this.row, !j ? "before" : "after");
      }, this);
      Object.forEach(
        h,
        function (j, k) {
          ...
          if (k != "p" && k != "n") {
            ...
            new Element('div[data-rokboxicon="' + k + '"]').inject(
              this["controls" + i]
            );
          }
          if (["p", "n"].contains(k)) {
      ...
      this.containerLoader.adopt(
        new Element("div." + this.options.data + "-loader-image")
      );
      this.containerCaption = new Element(
        "div[data-" +
          this.options.data +
          "caption]." +
          this.options.data +
    ...
    _loadImage: function (m, o) {
      var n = this.containerContent.getSize(),
        s,
        j,
        g = {};
      this.setType(o.type);
      if (e) {
        ...
        g = { width: k.width, height: k.height };
        k.dispose();
      }
      moofx(m).style({ opacity: 0, visibility: "hidden", display: "block" });
      if (a || e) {
        moofx(m).style({ width: "inherit" });
      }
      if (o.size) {
        moofx(m).style({ width: o.size[0], height: o.size[1] });
      }
      ...
      if (o.size && this.isFitting) {
        moofx(m).style({ width: null, height: null });
      }
      this.containerCaption
        .set("html", o.element.get("data-rokbox-caption") || "")
        .removeClass("rokbox-hidden");
      s = this.containerContent.getSize();
      if (o.videoSize) {
        s = { x: o.videoSize.width || s.x, y: o.videoSize.height || s.y };
      }
      ...
      if (!o.error && o.type != "element") {
        document
          .getElements(
            this.isFitting
              ? "[data-rokboxunfitscreen]"
              : "[data-rokboxfitscreen]"
          )
          .setStyle("display", m.width == s.x ? "none" : "block");
      } else {
        document
          .getElements(
            this.isFitting
      ...
      if (
        !o.error &&
        o.element.get("data-rokbox-caption") &&
        o.element.get("data-rokbox-caption").length
      ) {
      ...
      moofx(this.containerContent)["animate"](
        { width: s.x, height: s.y },
        {
          duration: 250,
          callback: function () {
            moofx(m).style({ display: "block", visibility: "visible" });
            if (o.html5 && m.play) {
              m.play();
            }
            moofx(m).style({
              maxWidth:
                (m.naturalWidth || g.width || m.width || m.videoWidth || s.x) +
                "px",
              maxHeight:
                (m.naturalHeight ||
                  g.height ||
            ...
            moofx(m)[!e ? "animate" : "style"]({ opacity: 1 });
            this.containerContent.setStyles({
              maxWidth: s.x,
              maxHeight: s.y,
              width: null,
    ...
    _loadIframe: function (k, m) {
      var l = this.containerContent.getSize(),
        q,
        h;
      k.removeEvents("load");
      this.setType(m.type);
      k.setStyles({ visibility: "hidden", display: "block" });
      ...
      moofx(this.containerContent).style({ maxWidth: null, maxHeight: null });
      this.containerCaption
        .set("html", m.element.get("data-rokbox-caption") || "")
        .removeClass("rokbox-hidden");
      ...
      h =
        this.container.getComputedSize({
          styles: ["padding", "border", "margin"],
      ...
      document
        ...
        .setStyle("display", "none");
      if (
        m.element.get("data-rokbox-caption") &&
        m.element.get("data-rokbox-caption").length
      ) {
        moofx(this.containerCaption.removeClass("rokbox-hidden")).animate({
          opacity: 1,
        });
    ...
    _loadElement: function (f, h) {
      ...
      f.adopt(
        g
          ...
          .cloneEvents(g)
          .setStyle("display", "block")
          .addClass("rokbox-content-element")
      );
      this._loadImage(f, h);
    },
    _setError: function (g, h) {
      ...
      if (h.type == "element") {
        f.set(
          ...
          "<h3>Error</h3><p>The " +
            ...
            " <code>" +
            h.rule +
            "</code> was not found in the DOM.</p>"
        );
      } else {
        if (
          h.type == "video" &&
          ...
          f.set(
            "html",
            "<h3>Error</h3><p>An error occurred while trying to load the " +
              h.type +
              " link: <br /> <code>" +
              h.href +
              '</code> <br />Note that Firefox does not support MP4 files. Try adding a WebM or Ogg converted file at the same location of the video above (<a target="_blank" href="https://developer.mozilla.org/en-US/docs/HTML/Supported_media_formats?redirectlocale=en-US&redirectslug=Media_formats_supported_by_the_audio_and_video_elements#WebM">More details</a>).</p>'
          );
        } else {
          f.set(
            "html",
      ...
      h.error = true;
      this["_load" + (h.type == "element" ? "Image" : h.type.capitalize())](
        f,
        h
      );
    },
    _resizeObject: function (h, k) {
      ...
      moofx(h).style({ maxWidth: size.x, maxHeight: size.y });
    },
